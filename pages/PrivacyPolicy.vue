<template>
  <section class="privacy-policy">
    ...
    <v-container>
      <v-card>
        <v-card-text>
          当サイトは，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。<br /><br />
          第1条（個人情報）
          ...
          第2条（個人情報の収集方法）
          当サイトは，ユーザーが利用登録をする際に氏名，メールアドレスなどの個人情報をお尋ねすることがあります。<br /><br />
          第3条（個人情報を収集・利用する目的）
          ...
          利用目的の変更を行った場合には，変更後の目的について，当サイト所定の方法により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。<br /><br />
          第5条（個人情報の第三者提供）
          ...
          当サイトが別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。<br /><br />
          第10条（お問い合わせ窓口）
          本ポリシーに関するお問い合わせは，CONTACTページより、お願いいたします。
        </v-card-text>
      </v-card>
    </v-container>
  </section>
